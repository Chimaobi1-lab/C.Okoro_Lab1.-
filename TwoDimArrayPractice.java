 ...
 * Description: : In this lab I will  work with a 4-row, 20-column, two-dimensional array of integers. 
 * I will write methods that perform the following operations:
 * Due: 03/11/2023
   ...
   */
   ...
   {  
    ...
    // Write your code here:
	   ...
	   System.out.println("count frequency of value="
	   		+ ""+value+" in the matrix.");
	      int count = 0;// This  will store count of the value
	      	for (int column = 0; column < intArray.length; 
	      	column ++){
	      		{
	      	...
	      	value +"occured is ="+ count);
	      	 return count;// we replace this line with our return statement 
